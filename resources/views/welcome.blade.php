...
<body>
    ...
    <main class="container" id="inicio">
        ...
        <section id="galeria" class="section">
            ...
            <div class="gallery">
                <article class="gallery-item span-7" data-label="Operación estratégica"></article>
                <article class="gallery-item span-5" data-label="Equipo profesional"></article>
                <article class="gallery-item span-4" data-label="Innovación constante"></article>
                <article class="gallery-item span-4" data-label="Gestión de proyectos"></article>
                <article class="gallery-item span-4" data-label="Alianzas de valor"></article>
            </div>
        </section>
        ...
        <section id="contacto" class="contact glass">
            ...
            <ul class="contact-list">
                ...
                <li>✉️ contacto@corporacionblessing.com</li>
